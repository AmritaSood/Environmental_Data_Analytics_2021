...
P.P.temperature <- ggplot(PeterPaul.chem.nutrients, aes(x=sampledate, y= temperature_C, color=depth), dotsize=0.5) + geom_point(size=0.5)+scale_color_viridis(option= "magma", direction = -1)
...
EPA<- read.csv("./Data/Processed/EPAair_O3_PM25_NC1718_Processed.csv")

air.plot <- ggplot(EPAair)+geom_point(aes(x=AQI))
